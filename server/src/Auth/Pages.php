...
final class Pages
{
    ...
    public const ALL = ['dashboard', 'buyers', 'campaigns', 'attendance', 'complete-report', 'users', 'logs'];

    /** Default pages a freshly created non-admin user can see (admin pages excluded). */
    public const DEFAULT_USER = ['dashboard', 'buyers', 'campaigns', 'attendance', 'complete-report'];
